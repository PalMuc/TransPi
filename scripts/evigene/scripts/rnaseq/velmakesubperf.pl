...
my $debug=1;
my $vprefix="subperf7b."; # subperf7
my $workd="/export/udisk2/work/aphid";
my $rnas="/bio/bio-grid/mb/rnaseq";
my $rrnafilt="$workd/misc/repeat_rrna.gff";

my $samfilter = "$rnas/rgsoft/samfiltergff.pl -expandover=50 -over $rrnafilt ";
my $sam2velv  = "$rnas/rgsoft/sam2velv.pl -debug -mismatch=0.05 -endclip=0.06 -hardclip -samout";
