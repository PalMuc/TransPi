...
vopts="-max_gap_count 5 -min_pair_count 2 $iopts" 
#o#oopts="-scaffolding yes -min_pair_count 3 -edgeFractionCutoff 0.03 -min_trans_lgth 200 $iopts"
oopts="-scaffolding yes -cov_cutoff 2 -min_pair_count 2 -edgeFractionCutoff 0.03 -min_trans_lgth 200 $iopts"
