...
pdf(paste(sample_name,"_BUSCO_comparison.pdf",sep=""),width = 15 ,height = 7)
print(figure)
dev.off()
svg(paste(sample_name,"_BUSCO_comparison.svg",sep=""),width = 15 ,height = 7)
print(figure)
dev.off()
print("Done")
